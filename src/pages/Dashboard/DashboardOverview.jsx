  ...
  return (
    <div className="dashboard-content-container">
      ...
      <div className="dashboard-grid">
        <div className="grid-left"><CompetitorActivityChart /></div>
        <div className="grid-right"><TopAlerts /></div>
      </div>

      <div className="dashboard-grid bottom-grid">
        <div className="grid-left"><AiInsights /></div>
        <div className="grid-right"><CompetitorSnapshot /></div>
      </div>
    </div>
  );
};
