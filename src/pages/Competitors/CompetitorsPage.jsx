      ...
      <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="inline-flex items-center rounded-3xl bg-slate-100 p-2.5 py-3.5 gap-2 shadow-sm">
          ...
          <button
            ...
            className={`flex items-center gap-4 rounded-2xl px-8 py-3.5 text-[17px] font-semibold transition ${
              activeTab === "all"
          ...
          <button
            ...
            className={`flex items-center gap-3 rounded-2xl px-7 py-3 text-[17px] font-semibold transition ${
              activeTab === "manual"
